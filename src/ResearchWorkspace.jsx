  ...
  return <div className="research-app" data-platform={platform} data-storage-mode={EXTENSION_MODE ? 'extension' : 'server'}>
    ...
    <main className="command-layout">
      ...
      <section className="workspace-canvas">
        ...
        {EXTENSION_MODE && <LocalExtensionPanel connected={Boolean(meta?.localExtension?.connected)} onRefresh={loadWorkspace} onRestored={async () => { setSearchStateReady(false); }} notify={notify} />}
