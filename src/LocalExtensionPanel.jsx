...
export function LocalExtensionPanel({ connected, onRefresh, onRestored, notify }) {
  ...
  return <section className="local-extension-panel" aria-label="本机助手与数据">
    ...
    <details open={!connected ? true : undefined}><summary>一次安装 · 数据管理 · 使用边界</summary>
      <ol><li><a href="/downloads/douyin-helper.zip" download>下载抖音本机助手 3.0.0</a>，先解压到固定文件夹。当前为手动安装版，尚未上架扩展商店。</li>
